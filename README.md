...
This repository contains code and tools for solving the steady-state 2D convection–diffusion equation with Physics-Informed Neural Networks. The work introduces and evaluates modified PINN architectures designed to improve accuracy and convergence relative to a standard fully connected PyTorch PINN baseline.
## Overview
